...
import com.example.viewpager2study.databinding.FragmentSBinding

class SFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_s, container, false)
        return binding.root
    }
